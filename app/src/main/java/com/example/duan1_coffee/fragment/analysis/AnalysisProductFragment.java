...
public class AnalysisProductFragment extends Fragment {


    public AnalysisProductFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_analysis_product, container, false);
